...
fish_pool = [
    ...
    {"name": "Puffer", "rarity": "Common", "icon": "🐟"},
    {"name": "Lazy Susan", "rarity": "Common", "icon": "🐟"},
    {"name": "Tea-Colored Shirakodai", "rarity": "Common", "icon": "🐟"},
    {"name": "Brown Shirakodai", "rarity": "Common", "icon": "🐟"},
    {"name": "Purple Shirakodai", "rarity": "Common", "icon": "🐟"},
    ...
    {"name": "Divda Ray", "rarity": "Rare", "icon": "🐠"},
    {"name": "Formalo Ray", "rarity": "Rare", "icon": "🐠"},
    {"name": "Maintenance Mek: Water", "rarity": "Rare", "icon": "🐠"},
    {"name": "Rippling Heartfeather Bass", "rarity": "Rare", "icon": "🐠"},
    {"name": "Streaming Axe Marlin", "rarity": "Rare", "icon": "🐠"},
    ...
    {"name": "Blazing Heartfeather Bass", "rarity": "Mythic", "icon": "🐡"},
    {"name": "Dawning Heartfeather Bass", "rarity": "Mythic", "icon": "🐡"},
    {"name": "Sternshield Crab", "rarity": "Mythic", "icon": "🦀"},
    {"name": "Lazurite Axe Marlin", "rarity": "Mythic", "icon": "🐡"},
    {"name": "True Fruit Angler", "rarity": "Mythic", "icon": "🐡"},
]
