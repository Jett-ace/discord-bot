...
- Your username (for leaderboards and display)
- Server ID (to know where commands are used)
- Your virtual currency, items, stats, and game history
...
- Process premium subscriptions and purchases
...
Your data may be visible in these cases:
- Public leaderboards show your username and stats
- Bot administrators can see data for support/maintenance
...
- Request deletion of your data (contact us on Discord)
