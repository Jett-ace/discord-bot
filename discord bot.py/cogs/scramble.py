...
# Word lists by difficulty - can include anagram tuples for words with multiple valid answers
# Format: "WORD" for single answer, or ("WORD1", "WORD2") for anagrams
WORD_LISTS = {
    "easy": [
        ("TEAM", "MATE", "MEAT", "TAME"), ("RACE", "CARE", "ACRE"), "JUMP", "CAKE", "PARK", "BIRD", "FISH", ("STAR", "RATS", "ARTS", "TARS"), "MOON", "TREE",
        "BOAT", "DOOR", "FIRE", "GOLD", "HOME", "KING", "LION", ("RAIN", "RANI"), ("WIND", "WDIN"), ("SNOW", "OWNS", "SOWN"),
        "COIN", "DECK", "FROG", "GIFT", "HAND", "IRON", "JADE", "KITE", "LAMP", "MASK",
        ("NOTE", "TONE"), "OVER", ("PEAK", "PAKE"), "RING", ("SHIP", "HIPS"), ("TIDE", "DIET", "EDIT", "TIED"), "UNIT", ("VASE", "SAVE"), "WAVE", "ZONE",
        "BELL", "CARD", ("DIAL", "LAID"), "EPIC", "FLAG", "GAME", "HERO", ("ISLE", "LIES"), "JOKE", "KEYS",
        "LUCK", "MAZE", ("NEWS", "SEWN"), ("OPEN", "PEON"), "PAGE", "QUIZ", "RUST", "SAFE", ("TIME", "MITE", "ITEM", "EMIT"),
        "UNDO", "ARCH", ("BARN", "BRAN"), "CLAW", ("DAWN", "WAND"), "EDGE", "FARM", "GATE", "HILL", "INCH", "JAIL",
        ("KEEP", "PEEK"), ("LEAF", "FLEA"), "MIST", ("NEST", "NETS", "TENS", "SENT"), "OATH", "PATH", "QUIT", ("ROBE", "BORE"), ("SAIL", "AILS"), ("TAIL", "LAIT"),
        "UGLY", ("VINE", "VEIN"), "WISE", "YARN", "ZOOM", "APEX", "BOLT", "CAVE", "DUCK", ("EAST", "EATS", "SEAT", "SATE"),
        "FANG", "GULF", "HAWK", "ICON", "JUNK", "KIWI", "LAVA", "MINT", "NOON", "OPAL",
        ("PEAR", "REAP"), "REEF", ("SALT", "LAST", "SLAT"), "TENT", ("VEIL", "EVIL", "LIVE", "VILE"), ("WAND", "DAWN"), "YELL", "ZERO", "AREA", "BEAM",
        ("COAT", "TACO"), ("DEER", "REED"), "EXAM", "FOIL", ("GLOW", "GOWL"), "HIVE", "IRIS", "JADE", "KNEE", "LENS",
        "MOLD", "NAIL", "OVEN", ("PAWS", "WASP", "SWAP"), "RICE", "SAGE", "TOMB", "URGE", "VIEW", ("WOLF", "FLOW"),
        "YAWN", "ABLE", "BEAM", "COIL", "DUSK", ("EARN", "NEAR"), "FLAP", "GAZE", "HORN", "IDOL",
        "JUMP", "KIND", "LOUD", "MILD", "NAVY", "ONLY", "PLUG", "RAMP", "SILK", "TOAD",
        "UNIT", "VICE", "WAIT", "YOLK", "ZEAL", ("ACNE", "CANE"), "BASH", "COZY", ("DROP", "PROD"), "EVEN",
        "FOAM", "GRIP", "HOUR", "IDEA", "JUST", "KALE", ("LURE", "RULE"), "MUTE", "NUMB", "OVAL",
        "PACT", "RASH", ("SLAP", "PALS", "LAPS"), "TRIM", "UNDO", "VOWS", "YANK", "ZEST", "ACME",
        "BUFF", "CRIB", ("DUEL", "LEWD"), "FOLD", "GRAM", "HUGE", "ITCH", "JOLT", "KELP",
        ("LOOP", "POOL", "POLO"), "MOTH", "NEON", "ODDS", ("PALM", "LAMP"), ("RUSE", "USER", "SURE"), "SODA", "TAXI", "VERB",
        ("POTS", "STOP", "TOPS", "SPOT", "POST", "OPTS"), ("STEP", "PEST", "PETS"), ("DEAL", "LEAD", "DALE"), ("RATE", "TEAR", "TARE"),
        ("SNAP", "PANS", "NAPS", "SPAN"), ("BATS", "STAB", "TABS"), ("HATE", "HEAT"), ("BLOW", "BOWL"), ("MEAN", "NAME", "MANE"),
        ("PINS", "SPIN", "SNIP"), ("TIES", "SITE"), ("LATE", "TALE"), ("PALE", "LEAP", "PEAL", "PLEA"), ("BALE", "ABLE", "BELA"),
        ("MILE", "LIME"), ("DOSE", "DOES", "ODES"), ("RISE", "SIRE"), ("SOLE", "LOSE"), ("TONE", "NOTE"), ("TOPS", "POTS", "STOP", "SPOT", "POST", "OPTS")
    ],
    "medium": [
        "APPLE", "PHONE", "MUSIC", "MONEY", ("WATER", "WRATE"), "HOUSE", "CHAIR", "TABLE", "CLOCK", "LIGHT",
        "PAPER", "SHIRT", ("PANTS", "PANT"), "SHOES", "WATCH", ("BREAD", "BEARD", "BARED"), "LUNCH", "DRINK", ("SMILE", "SLIME", "MILES"), ("HEART", "EARTH", "HATER"),
        "BEACH", "CLOUD", ("STORM", "SPORT"), "GRASS", "PLANT", ("STONE", "NOTES", "TONES"), "RIVER", ("OCEAN", "CANOE"), "WORLD", "SPEED",
        "PIZZA", ("SWEET", "WEEST"), "SPICY", "FRESH", ("CLEAN", "LANCE"), "QUICK", ("SLEEP", "PEELS"), ("DREAM", "ARMED"), "PARTY", "DANCE",
        "POWER", "MAGIC", "BRAVE", "SMART", "HAPPY", ("PEACE", "PEACH"), "TRUST", "VOICE", "MOVIE", "SIGHT",
        "PLACE", "SPACE", ("TRAIN", "RIANT"), ("PLANE", "PANEL", "PENAL"), "DRIVE", "FIGHT", "WRITE", ("LEARN", "RENAL"), "TEACH", "COUNT",
        "ABOUT", "AFTER", ("ANGLE", "ANGEL", "GLEAN"), ("ARROW", "ROWAN"), "BADGE", ("BAKER", "BRAKE", "BREAK"), "BENCH", ("BLEND", "BLEED"), "BLOCK", ("BOARD", "BROAD", "BARDO"),
        "BRAIN", "BRAND", "BRICK", "BUNCH", "BURST", "CABIN", "CANAL", "CANDY", "CARGO",
        "CATCH", "CHAIN", "CHARM", ("CHEAP", "PEACH"), "CHEST", "CHIEF", "CHINA", "CLAIM", "CLASS", "COACH",
        "COAST", "CORAL", "COUCH", "COURT", "COVER", "CRACK", "CRASH", "CRAZY", ("CREAM", "MACER"), "CROWN",
        "CURVE", "DAILY", ("DAIRY", "DIARY"), "DEPTH", "DIRTY", "DOUBT", "DRAFT", "DRAIN", "DRAWN", "DROWN",
        "EAGLE", ("EARLY", "LAYER", "RELAY"), ("EARTH", "HEART", "HATER"), "EMPTY", "ENEMY", "ENJOY", "EQUAL", "ERROR", "EXACT", "EXTRA",
        "FANCY", "FAULT", "FEVER", "FIELD", "FINAL", ("FLAME", "FLEMA"), "FLASH", ("FLEET", "FLETA"), "FLOOD", "FLOUR",
        "FLUID", "FORGE", "FORTH", ("FRAME", "FERMA"), "FRANK", "FRAUD", "FROST", "FRUIT", "GAUGE", "GHOST",
        "GIANT", "GLORY", ("GLOVE", "VOGEL"), ("GRACE", "CAGER"), "GRADE", ("GRAIN", "GROAN"), "GRAND", "GRANT", "GREET", "GRIEF",
        "GRILL", "GRIND", "GROSS", "GROUP", "GROVE", "GUARD", "GUESS", ("GUEST", "GUSTE"), "GUIDE", "GUILT",
        "HARSH", ("HASTE", "HEATS"), "HOBBY", "HONEY", "HONOR", ("HORSE", "SHORE"), "HOTEL", "HUMAN", "HUMOR",
        "IDEAL", "IMAGE", "INDEX", "INNER", "INPUT", "ISSUE", "IVORY", "JOKER", "JOINT", "JUICE",
        "KNIFE", "LABEL", "LABOR", ("LASER", "REALS"), "LEGAL", ("LEMON", "MELON"), "LEVEL", "LIMIT", "LOCAL",
        "LOOSE", "LOWER", "LOYAL", "LUCKY", "LUNAR", "MAJOR", ("MAPLE", "AMPLE"), "MARCH", "MATCH", "MAYOR",
        ("STARE", "TEARS", "RATES", "ASTER"), ("SLATE", "LEAST", "STEAL", "STALE", "TALES"), ("PEARS", "SPARE", "REAPS", "PARSE"),
        ("SNARE", "EARNS", "NEARS"), ("STORE", "ROTES"), ("CARES", "RACES", "ACRES", "SCARE"), ("PORTS", "SPORT", "STROP"),
        ("ALERT", "ALTER", "LATER"), ("MEATS", "STEAM", "TEAMS", "MATES"), ("TRIES", "TIRES", "RITES"), ("DEALS", "LEADS", "DALES"),
        ("LOOPS", "POOLS", "SPOOL"), ("ROPES", "SPORE", "PORES"), ("ASPEN", "PANES", "NAPES"), ("CRUEL", "LUCRE"),
        ("WASTE", "SWEAT"), ("DATES", "SATED", "STADE"), ("LEASE", "EASEL"), ("TAPES", "PASTE", "PATES"), ("SIREN", "RESIN", "RISEN")
    ],
    "hard": [
        ...
        ("KITCHEN", "THICKEN"), ("TEACHER", "CHEATER"), ("SECTION", "NOTICES"), ("NASTIER", "RETAINS", "RETINAS"),
        ("PAINTER", "REPAINT"), ("CARTHORSE", "ORCHESTRA"), ("SILENT", "LISTEN", "ENLIST"), ("ACTERS", "CASTERS", "RECASTS"),
        ("CRESTAL", "CARTELS", "CLARETS"), ("MASTERING", "STREAMING"), ("RESTFUL", "FLUSTER"), ("SALTIER", "REALIST", "RETAILS")
    ],
    "expert": [
        "CHOCOLATE", "TELEPHONE", "YESTERDAY", "BEAUTIFUL", "IMPORTANT", "SOMETHING", "DIFFERENT",
        "SOMEWHERE", "EVERYBODY", "COMMUNITY", "EDUCATION", "CHRISTMAS", "WEDNESDAY",
        "SEPTEMBER", "HAMBURGER", "VALENTINE", "PINEAPPLE", "BUTTERFLY", "FANTASTIC", "CELEBRATE",
        "ADVENTURE", "BREAKFAST", "UNDERSTAND", "APARTMENT", "NEWSPAPER", "SPAGHETTI",
        ...
        "NECESSARY", "CONFIDENT", "EQUIPMENT", "LANDSCAPE", "MESSENGER", "SCIENTIST",
        "RECOGNIZE", "TECHNIQUE", "NIGHTMARE", "WONDERFUL", "CROCODILE", "ORGANIZED",
        ...
        ("CHOCOLATE", "ACHOCOLET"), ("EDUCATION", "CAUTIONED"), ("CHRISTMAS", "CHRISTMSA"), ("BEAUTIFUL", "BEAUTILFU"),
        ("SOMETHING", "SOMETHIGN"), ("HAMBURGER", "HAMBURGRE"), ("BUTTERFLY", "BUTTERFYL"), ("CELEBRATE", "CELEBARTE"),
        ("INTERVIEW", "INTERVEIW"), ("LANDSCAPE", "LANDSCPAE"), ("WONDERFUL", "WONDERFLU"), ("CROCODILE", "CROCODLIE")
    ]
}
...
class Scramble(commands.Cog):
    def __init__(self, bot):
        ...
        self.timeout_tasks = {}  # user_id: timeout task
    ...
    async def scramble(self, ctx, bet: str = None, difficulty: str = None):
        ...
        # Select random word (may be tuple of anagrams or single word)
        word_choice = random.choice(WORD_LISTS[diff])
        
        # Handle anagrams - if tuple, accept all variations
        if isinstance(word_choice, tuple):
            valid_answers = list(word_choice)
            word = valid_answers[0]  # Primary word to display if they lose
        else:
            valid_answers = [word_choice]
            word = word_choice
        ...
        self.active_games[ctx.author.id] = {
            "word": word,  # Primary answer to display
            "valid_answers": valid_answers,  # All acceptable answers
            "scrambled": scrambled,
            "difficulty": diff,
            "bet": bet_amount,
        ...
        if ctx.author.id in self.timeout_tasks:
            self.timeout_tasks[ctx.author.id].cancel()
        
        # Start timeout checker and countdown updater
        self.timeout_tasks[ctx.author.id] = asyncio.create_task(self.game_timeout(ctx.author.id, time_limit))
    ...
    async def game_timeout(self, user_id, time_limit):
        """Handle game timeout"""
        try:
            # Wait for the full time limit
            await asyncio.sleep(time_limit)
            
            # Check if user still has THIS specific game active
            if user_id not in self.active_games:
                # Game was already finished/cancelled
                return
    ...
    async def on_message(self, message):
        ...
        if message.author.id in self.endless_games:
            ...
            # Check answer - accept any valid answer
            valid_answers = game.get("valid_answers", [game["word"]])
            if user_answer in valid_answers:
                ...
                word_choice = random.choice(WORD_LISTS[game["difficulty"]])
                ...
                scrambled = self.scramble_word(word)
                game["word"] = word
                game["valid_answers"] = valid_answers
        ...
        if user_answer in valid_answers:
            ...
            # Cancel timeout task
            if message.author.id in self.timeout_tasks:
                self.timeout_tasks[message.author.id].cancel()
                del self.timeout_tasks[message.author.id]
