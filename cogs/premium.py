        ...
        if value == "overview":
            ...
            embed.add_field(
                ...
                value=(
                    ...
                    "<a:arrow:1437968863026479258> **3x betting limits** on all games\n"
                    ...
                    "<a:arrow:1437968863026479258> **10% discount on Black Market items**\n"
                    "<a:arrow:1437968863026479258> **Shorter rob cooldowns** (20/40min vs 30/60min)\n"
                    "<a:arrow:1437968863026479258> **+15% rob success rate**"
                ),
                inline=False
            )
            embed.add_field(
                ...
                value=(
                    ...
                    "<a:arrow:1437968863026479258> **5M sign-up bonus**"
                ),
                inline=False
            )
            embed.add_field(
            ...
            embed = discord.Embed(
                ...
                description="How Premium gives you an edge in games!",
                color=0x9B59B6
            )
            embed.add_field(
                name="💰 Betting Limits",
            ...
            embed.add_field(
                ...
                value=(
                    ...
                    "<a:arrow:1437968863026479258> **15% better odds** - bot picks losing choice 15% of time\n"
                    "<a:arrow:1437968863026479258> Win rate: ~48% instead of 33%"
                ),
                inline=False
            )
            embed.add_field(
                ...
                value=(
                    "<a:arrow:1437968863026479258> **Improved odds distribution**\n"
                    "<a:arrow:1437968863026479258> Less bad outcomes (0.2x/0.5x reduced)\n"
                    "<a:arrow:1437968863026479258> More good outcomes (2x/5x/10x increased)\n"
                    "<a:arrow:1437968863026479258> **2x jackpot chance** (2% vs 1%)"
                ),
                inline=False
            )
            embed.add_field(
                name="🪙 Coinflip",
                value=(
                    "<a:arrow:1437968863026479258> **+8% win chance bonus**\n"
                    "<a:arrow:1437968863026479258> Losses converted to wins 8% of time\n"
                    "<a:arrow:1437968863026479258> Win rate: ~58% instead of 50%"
                ),
                inline=False
            )
            embed.add_field(
                ...
                value=(
                    ...
                    "<a:arrow:1437968863026479258> Picks highest value symbol\n"
                    "<a:arrow:1437968863026479258> Much better jackpot odds"
                ),
                inline=False
            )
            embed.add_field(
            ...
            embed.add_field(
                ...
                value=(
                    ...
                    "<a:arrow:1437968863026479258> Much higher success with items"
                ),
                inline=False
            )
            embed.add_field(
                ...
                value=(
                    "<a:arrow:1437968863026479258> **10% discount on all items**\n"
            ...
            embed.add_field(
                ...
                value=(
                    "<a:arrow:1437968863026479258> Exclusive luck bonuses\n"
                    "<a:arrow:1437968863026479258> Win more often\n"
                    "<a:arrow:1437968863026479258> Subtle but powerful advantage"
                ),
                inline=False
            )
            await interaction.response.send_message(embed=embed, ephemeral=True)
...
class Premium(commands.Cog):
    ...
    async def premium_info(self, ctx):
        ...
        embed.add_field(
            ...
            value=(
                "<a:arrow:1437968863026479258> AI Chat Bot (`ghey`)\n"
                "<a:arrow:1437968863026479258> Better luck in games\n"
